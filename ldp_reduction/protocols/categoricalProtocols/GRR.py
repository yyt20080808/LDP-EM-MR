import math
import numpy as np
from ldp_reduction.protocols.MR.GRR_EM_reduction import noisedP2hist
import random
from ldp_reduction.protocols.SP2023convo.deconvvolution_ldp import *
...
def norm_sub(est_value_list, user_num , tolerance = 100):
